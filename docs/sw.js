const CACHE='life-stable-v5-4';
const FILES=['./','./index.html','./style.css','./app.js','./task-model.js','./hr-model.js','./hr.js','./manifest.webmanifest','./icons/icon-192.png','./icons/icon-512.png','./icons/maskable-512.png'];
