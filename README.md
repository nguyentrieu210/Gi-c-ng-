...
- [`CAREER_REVIEW.md`](./CAREER_REVIEW.md) — kết quả rà soát PR và quy tắc đọc hồ sơ tuyển dụng.
- [`OPERATING_MODEL.md`](./OPERATING_MODEL.md) — mô hình dùng dữ kiện để chọn bước tiếp theo.
